export default class Clock {
  ...
  start () {
    if (typeof this.bpm !== 'number') throw new TypeError('clock start() failed: bpm not set')
  ...
  setBpm (bpm) {
    if (typeof bpm !== 'number') throw new TypeError('clock setBpm() failed: bpm is not a number')
    this.bpm = bpm
